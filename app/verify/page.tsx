        ...
        <div className="mx-auto w-full max-w-xl">
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.045] p-6 shadow-2xl shadow-black/25 backdrop-blur-xl sm:p-9">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-black">
                    Why do we verify your email?
                  </p>

                  <p className="mt-1 text-xs leading-5 text-white/35">
                    Email verification helps protect your account
                    and ensures your LiveProject profile can be
                    securely connected to your professional journey.
                  </p>
                </div>
              </div>
            </div>
            ...
            <p className="mt-7 text-center text-xs leading-5 text-white/25">
              ...
              >
                Go back and edit your registration
              </button>
            </p>
          </div>
        </div>
